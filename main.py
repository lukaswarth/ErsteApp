...
class Kasino(Screen):
    ...
    def __init__(self, **kwargs):
        super(Kasino, self).__init__(**kwargs)
        self.initial = None

    def on_touch_move(self, touch):
        if self.initial is None:
            self.initial = touch.x
        if touch.x > self.initial * 2:  
            self.manager.current = "GameOne"
            self.manager.transition.direction = "right"
            self.initial = None
        elif touch.x < self.initial * 0.65:
    ...
    def on_enter(self):
        ...
        self.ids.schwer.text = self.manager.shared_variable
...
class GameOne(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameOne, self).__init__(**kwargs)
        self.initial = None

    def on_touch_move(self, touch):
        if self.initial is None:
            self.initial = touch.y
        if touch.y < self.initial * 0.65:  
...
class GameTwo(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameTwo, self).__init__(**kwargs)
        self.initial = None

    def on_touch_move(self, touch):
        if self.initial is None:
            self.initial = touch.y
        if touch.y > self.initial * 2:  
            self.manager.current = "GameFour"
            self.manager.transition.direction = "up"
            self.initial = None
        elif touch.x > self.initial * 2:
            self.manager.current = "Kasino"
            self.manager.transition.direction = "right"
            self.initial = None
...
class GameThree(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameThree, self).__init__(**kwargs)
        self.initial = None
...
class GameFour(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameFour, self).__init__(**kwargs)
        self.initial = None
...
class GameFive(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameFive, self).__init__(**kwargs)
        self.initial = None
        self.orientation = 'vertical'  # Orientierung des Layouts
        self.TikTakToe = []
        self.create_ttt()
...
class GameSix(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameSix, self).__init__(**kwargs)
        self.initial = None
...
class GameSeven(Screen, BoxLayout):
    ...
    def __init__(self, **kwargs):
        super(GameSeven, self).__init__(**kwargs)
        self.initial = None
...
class GameEight(Screen):
    ...
    def __init__(self, **kwargs):
        super(GameEight, self).__init__(**kwargs)
        self.initial = None
...
class Upgrades(Screen):
    ...
    def __init__(self, **kwargs):
        super(Upgrades, self).__init__(**kwargs)
        self.initial = None
