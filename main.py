...
class GameOne(Screen):
    ...
    def button_s1(self):
        ...
        self.ids.geld4.text = str(int(self.ids.geld4.text) + 1 * int(self.ids.schwer1.text) * self.pro_klick)
        self.e = self.e + 1 * int(self.ids.schwer1.text) * self.pro_klick
        ...
        if self.ids.bar.value == 20 * int(self.ids.schwer1.text):
            ...
            self.e = self.e + round(50 * int(self.ids.schwer1.text)) * self.pro_balken
            save_einnahmen("GameOne", self.e)
